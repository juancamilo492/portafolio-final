...
año: "2025"
rol: "Chef d’équipe — prototype fonctionnel (ESP32 et jeu par gestes), rendu de l’espace et une grande partie du développement"
categoria: ["Inmersivo", "Investigación", "UX/UI"]
herramientas: ["ESP32", "OpenCV", "Streamlit", "Python"]
destacado: true
orden: 5
...
de l’espace et d’une grande partie du développement du projet.
...
choisir un animal ; la sélection transforme toute l’ambiance — lumière, son — et
...
étaient des étudiants universitaires et non des enfants — suffisant pour
évaluer l’architecture de l’information, insuffisant pour considérer
...
la question la plus importante — un enfant de 10 ans prend-il du plaisir à
cela ? — est restée ouverte. J’ai appris que l’accès aux bons utilisateurs se
