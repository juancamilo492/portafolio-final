...
![Screenshot of the initial form interface for the Cafés de Colombia Expo 2025 trade fair: over a background photo featuring coffee beans and a cup, a central card with the header “Tómate un cafecito y transformemos juntos tu empaque”, the caption “Queremos conocer tu visión para reflejar la esencia de tu café” and the golden button “¡CREEMOS EL EMPAQUE PERFECTO!”.](../../../assets/proyectos/empaques-ia-alico/formulario-expo-cafe.png)

Interface of the interactive creative brief form designed for Cafés de Colombia Expo 2025, where coffee growers defined their brand’s vision in 19 steps.
:::
...
:::figura{ancho ampliar}
![Screenshot of the evolved web platform titled “Formulario IA”: over a blue-to-gold gradient background, it displays the headline “Transforma tu empaque con Inteligencia Artificial”, the description for generating realistic images of Doy Pack, Flow Pack and Thermoforming, and the buttons “Comenzar gratis” and “Ya tengo cuenta”.](../../../assets/proyectos/empaques-ia-alico/plataforma-ia-empaques.png)

Interface of the evolved pre-sales web platform for Alico S.A.S BIC, where clients upload their brand and select packaging formats to generate AI renders.
:::

:::galeria
![AI-generated render of a Doypack pouch with top spout and red floral pattern on a supermarket shelf, accompanied below by the character logo, pattern and empty base pouch.](../../../assets/proyectos/empaques-ia-alico/render-doypack-estante.jpg)

![AI-generated render of a clear thermoformed container filled with fresh grapes and brand applied on the lid, accompanied below by the base plastic container and client logo.](../../../assets/proyectos/empaques-ia-alico/render-termoformado-uvas.jpg)

![AI-generated render of a clear bakery thermoformed container holding four cupcakes in a bakery setting, accompanied below by the plastic container and colorful bird logo.](../../../assets/proyectos/empaques-ia-alico/render-termoformado-cupcakes.jpg)

Examples of realistic renders generated automatically by the platform applying client brand, pattern, and chosen packaging format (spouted Doypack and food thermoformed containers).
:::
