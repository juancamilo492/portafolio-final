---
titulo: "i-Homotic: del voz a voz a una presencia digital que genera confianza"
slug: "i-homotic"
cliente: "i-Homotic (GELECT S.A.S)"
año: "2026"
rol: "Entrevistas, experiencias interactivas del sitio y coordinación de equipo — equipo de 6"
...
destacado: true
orden: 1
resumen: "Proyecto de grado con cliente real: estrategia de experiencia completa — sitio web interactivo, propuesta de stand para feria y manual de marca — para que una empresa de domótica deje de depender del voz a voz."
...
y desarrollo de las experiencias interactivas del sitio, y buena parte de la
...
valida digitalmente a los proveedores antes de contratarlos — y un patrón
determinante: la gente no cree en la domótica por lo que le cuentan, sino
por lo que puede probar; y adopta por expansión gradual, empezando pequeño.

Por eso el sitio no informa: **deja experimentar**. Ahí entraron los
elementos interactivos que diseñé y desarrollé: una calculadora de
presupuesto y ahorro energético que reduce la percepción de riesgo económico
antes del primer contacto, y un mapa 3D explorable de una vivienda
automatizada — construido con Three.js — donde el usuario recorre los
espacios, ve qué dispositivos tendría cada uno, y desde ahí mismo pasa al
contacto con un "quiero esto en mi casa".

## Lo que construimos

El proyecto entregó un ecosistema completo de comunicación:

- **Sitio web** en React con seis vistas, bilingüe ES/EN, con las
  experiencias interactivas integradas y desplegado en producción
...
sitio en producción, manual de marca, modelo 3D del stand.

En la escala Likert, los tres entregables superaron el umbral de 4.0. Del
sitio, lo mejor evaluado fue la disposición a agendar una visita (4.8), la
claridad pedagógica sin tecnicismos (4.6) y la utilidad de las experiencias
interactivas para imaginar la solución en el propio hogar (4.6). El stand
alcanzó 5.0 en generar curiosidad por la marca y en comunicar que la
